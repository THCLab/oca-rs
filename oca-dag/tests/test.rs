...
fn generate_commands() -> Vec<ast::Command> {
    ...
    attributes.insert("name".to_string(), ast::NestedAttrType::Value(ast::AttributeType::Text));
    attributes.insert("last_name".to_string(), ast::NestedAttrType::Value(ast::AttributeType::Text));
